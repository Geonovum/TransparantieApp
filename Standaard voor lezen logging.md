...
## Beleidsjuridischkader
Specifiek voor de extensie lezen is een [beleidsjuridischkader]https://logius-standaarden.github.io/logboek-extensie-lezen/#juridische-beleidskader) opgesteld. Dit geeft de kaders aan de specifiek van belang zijn wanneer de extensie lezen wordt toegepast. Dit kader is een aanvulling op het [juridisch beleidskader](https://gitdocumentatie.logius.nl/publicatie/logboek/juridisch/1.0.0/) voor de standaard logboek dataverwerkingen in zijn algemeenheid.
...
De werkversie van de [Open API specificatie voor de extensie lezen wordt bijgehouden in de Logius github](https://github.com/Logius-standaarden/logboek-extensie-lezen/blob/develop/media/openapi.json).
